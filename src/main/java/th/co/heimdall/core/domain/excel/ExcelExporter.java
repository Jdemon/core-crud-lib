package th.co.heimdall.core.domain.excel;
...
import th.co.heimdall.core.domain.exception.ExcelException;
...
public class ExcelExporter<T> {
    ...
    private void writeHeaderLine(XSSFWorkbook workbook) {
        this.sheet = workbook.createSheet(clazz.getSimpleName().toUpperCase());
